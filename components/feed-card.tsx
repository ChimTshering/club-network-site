      ...
      <div className="flex justify-between px-3">
        <div className="flex gap-2">
          <div className="relative rounded-full overflow-hidden h-[50px] w-[50px] flex flex-wrap justify-center content-center">
            <Image src={feed.actor.image || naruto.src} alt="" fill />
          </div>
          <div>
        ...
        <div>
          ...
          {menuPopUp ? (
            <div className="absolute bg-white p-4 rounded-md drop-shadow-lg m-1 z-10 text-gray-600">
        ...
        {feed.item.type === "news" ? (
          <div className="flex flex-wrap m-2 mx-3">
            <div className="relative w-5/12 h-[250px] overflow-hidden">
              <Image src={originalUrl ?? news.src} alt="" fill />
            </div>
